        ...
        <div class="p-3 ml-20">
            <form action="{{ route('products.update', ['product' => $product->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="relative z-0 mb-6 w-full group">
                    ...
                    <input type="number" class="ml-5 p-2 pl-4 w-3/4 border-2 border-gray-300 rounded-lg" name="จำนวนสินค้าคงคลัง" id="จำนวนสินค้าคงคลัง" value="{{ old('จำนวนสินค้าคงคลัง', $product->จำนวนสินค้าคงคลัง) }}" placeholder="" min="1" required>
                </div>
